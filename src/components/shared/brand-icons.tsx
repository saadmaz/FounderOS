...
/**
 * Real brand marks for the social platforms a Company can link out to -
 * lucide-react is a generic (deliberately un-branded) icon set with no
 * LinkedIn/X/Instagram glyphs, so these stand in wherever those platforms
 * are shown (company form labels, company header link pills). Path data is
 * each platform's official logo (Simple Icons, CC0), single-color and
 * `currentColor`-filled so they drop into the same `className="size-3.5"`
 * usage as any lucide icon and inherit surrounding text color.
 */
